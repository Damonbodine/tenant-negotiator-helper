-- Manual Migration Script for Rental Negotiation Architecture
-- Copy and paste this into your Supabase SQL Editor
-- This combines all migrations: 20250103000001 and 20250103000002
...
CREATE TABLE IF NOT EXISTS user_profiles_rental (
...
-- Function to get user's property context (FIXED VERSION)
...
-- COMPLETED! 
-- =============================================
-- Your Rental Negotiation Memory Architecture is now installed!
-- You can now use the RentalMemoryService TypeScript class to interact with these tables. 